...
"""
当前最新优化方案 - 300期详细回测列表
参数：lookback=10, good_thresh=0.30, bad_thresh=0.20, boost=1.2, reduce=0.5, max=10
"""
...
print("=" * 80)
print("当前最新优化方案 - 300期详细回测")
print("=" * 80)
print(f"配置参数:")
print(f"  回看窗口: {LOOKBACK}期")
print(f"  增强阈值: {GOOD_THRESH*100:.0f}% (命中率>=30%时增强)")
...
# 保存到CSV
output_file = 'latest_optimized_300periods_detail.csv'
